...
import android.graphics.Point; // ===== 新增导入 =====
            ...
            case MotionEvent.ACTION_MOVE: {
                if (pointerCount == 1 && !isMultiFinger) {
                    ...
                    if (smoothDx != 0f || smoothDy != 0f) {
                        ...
                        float moveX = smoothDx * effectiveSpeed;
                        float moveY = smoothDy * effectiveSpeed;
